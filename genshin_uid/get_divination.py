...
bt = ImageFont.truetype(os.path.join(INDEX_PATH,"font/YangRenDongZhuShiTi-Regular-2.ttf"), 80)
gt = ImageFont.truetype(os.path.join(INDEX_PATH,"font/YangRenDongZhuShiTi-Regular-2.ttf"), 36)
gy = ImageFont.truetype(os.path.join(INDEX_PATH,"font/YangRenDongZhuShiTi-Regular-2.ttf"), 55)
cx = ImageFont.truetype(os.path.join(INDEX_PATH,"font/YangRenDongZhuShiTi-Regular-2.ttf"), 24)
